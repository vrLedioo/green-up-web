...
export const INTENTS: Intent[] = [
  ...
  },
  {
    ...
    response: {
      sq: "Instalojmë ashensorë pasagjerësh (2–30+ persona), ashensorë mallrash, industrialë dhe panoramikë me xham. Punojmë sipas standardeve EN 81-20/50 dhe CE, me dokumentacion të plotë. Instalimi zgjat zakonisht 3–7 ditë pune.",
      en: "We install passenger elevators (2–30+ persons), cargo, industrial, and panoramic glass elevators. All per EN 81-20/50 and CE standards, with complete documentation. Installation typically takes 3–7 working days.",
      de: "Wir installieren Personenaufzüge (2–30+ Personen), Waren-, Industrie- und Panoramaaufzüge. Alles nach EN 81-20/50 und CE-Normen mit vollständiger Dokumentation. Die Installation dauert in der Regel 3–7 Arbeitstage.",
    },
  ...
  },
  {
    ...
    response: {
      sq: "Të gjithë ashensorët tanë certifikohen sipas standardeve evropiane EN 81-20/50 (Direktiva 2014/33/EU) dhe i nënshtrohen inspektimit të rregullt nga organet kompetente. Siguria është prioriteti ynë kryesor.",
      en: "All our elevators are certified per European EN 81-20/50 standards (Directive 2014/33/EU) and undergo regular inspection by competent bodies. Safety is our top priority.",
      de: "Alle unsere Aufzüge sind nach europäischen EN 81-20/50-Normen (Richtlinie 2014/33/EU) zertifiziert und werden regelmäßig von zuständigen Behörden inspiziert. Sicherheit hat höchste Priorität.",
    },
